...
# button (gray_stained_glass_pane)
    ...
    data modify storage inv_gui: in.listener set value "Frame"
...
# button (barrier)
    ...
    data modify storage inv_gui: in.key set value "B"
    data modify storage inv_gui: in.listener set value "Back"
    function inv_gui:api/register_item/button
...
# Set menu contents
    ...
    data modify storage inv_gui: in.contents append value [f, D, D, D, -, -, -, -, f]
    data modify storage inv_gui: in.contents append value [f, f, f, f, f, f, f, f, B]

# Create a menu
    data modify storage inv_gui: in.id set value "dimensions"
