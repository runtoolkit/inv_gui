...
# button (oak_door)
    ...
    data modify storage inv_gui: in.listener set value "DimensionsMenu"
    function inv_gui:api/register_item/button


# Set menu contents
    data modify storage inv_gui: in.contents append value [f, f, f, f, f, f, f, f, f]
    data modify storage inv_gui: in.contents append value [f, -, -, -, D, -, -, -, f]
    data modify storage inv_gui: in.contents append value [f, f, f, f, f, f, f, f, f]

# Create a menu
    data modify storage inv_gui: in.id set value "main"
