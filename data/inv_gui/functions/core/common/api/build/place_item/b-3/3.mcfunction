#> inv_gui:datacore/common/api/build/place_item/b-3/3
# @within function inv_gui:datacore/common/api/build/place_item/b-2/1

execute if score $TargetSlot InvGui matches 11..12 run function inv_gui:datacore/common/api/build/place_item/b-4/5
