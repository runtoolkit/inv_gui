...
#>
# @public
    #alias vector Inv GUI 10000 0 10000
...
#>
# @public
    #declare tag Inv GUI.Target
    #declare tag Inv GUI.Player
...
#> Scoreboards
# @within * inv_gui:**
    #declare objective Inv GUI
    #declare objective Inv GUI.Id
    #declare objective Inv GUI.Drop
...
# @within * inv_gui:**
    #declare tag Inv GUI.Entity

#> Tag for entity identification
# @within * inv_gui:**
    #declare tag Inv GUI.Filter.0-0
    #declare tag Inv GUI.Filter.1-0
    #declare tag Inv GUI.Filter.2-0
    #declare tag Inv GUI.Filter.3-0
    #declare tag Inv GUI.Filter.4-0
    #declare tag Inv GUI.Filter.5-0
    #declare tag Inv GUI.Filter.6-0
    #declare tag Inv GUI.Filter.7-0
    #declare tag Inv GUI.Filter.8-0
    #declare tag Inv GUI.Filter.9-0
    #declare tag Inv GUI.Filter.10-0
    #declare tag Inv GUI.Filter.11-0
    #declare tag Inv GUI.Filter.12-0
    #declare tag Inv GUI.Filter.13-0
    #declare tag Inv GUI.Filter.14-0
    #declare tag Inv GUI.Filter.15-0
    #declare tag Inv GUI.Filter.0-1
    #declare tag Inv GUI.Filter.1-1
    #declare tag Inv GUI.Filter.2-1
    #declare tag Inv GUI.Filter.3-1
    #declare tag Inv GUI.Filter.4-1
    #declare tag Inv GUI.Filter.5-1
    #declare tag Inv GUI.Filter.6-1
    #declare tag Inv GUI.Filter.7-1
    #declare tag Inv GUI.Filter.8-1
    #declare tag Inv GUI.Filter.9-1
    #declare tag Inv GUI.Filter.10-1
    #declare tag Inv GUI.Filter.11-1
    #declare tag Inv GUI.Filter.12-1
    #declare tag Inv GUI.Filter.13-1
    #declare tag Inv GUI.Filter.14-1
    #declare tag Inv GUI.Filter.15-1
